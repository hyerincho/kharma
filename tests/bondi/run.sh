...
conv_2d() {
    ...
    do
      ...
      $BASE/run.sh -b ../kharma_wks_ratio2.cuda -i $BASE/pars/bondi.par parthenon/output0/dt=1000 parthenon/output1/dt=1000 debug/verbose=1 \
        ...
        mv bondi.out1.00000.rhdf bondi_2d_${res}_start_${1}.rhdf
        mv bondi.out1.final.rhdf bondi_2d_${res}_end_${1}.rhdf
    done
    check_code=0
...
conv_2d wks coordinates/transform=wks "in 2D, WKS coordinates"
